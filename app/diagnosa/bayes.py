...
def getAtribut(kriteria):
    ...
    def getJumlahKriteria(kriteria, y, z):
        jmlkriteria = datatraining[
            (datatraining[kriteria] == y) & (datatraining["c"] == z)
        ]
    ...
    result = (
        (jk1c1, jk1c2, jk1c3, jk1c4, k1c1, k1c2, k1c3, k1c4),
        (jk2c1, jk2c2, jk2c3, jk2c4, k2c1, k2c2, k2c3, k2c4),
        (jk3c1, jk3c2, jk3c3, jk3c4, k3c1, k3c2, k3c3, k3c4),
        (jk4c1, jk4c2, jk4c3, jk4c4, k4c1, k4c2, k4c3, k4c4),
    )
    return result
...
def likehood(id_pasien):
    ...
    result = (
        (P1C1, P2C1, P3C1, P4C1, P5C1, P6C1, P7C1, PC1, C1),
        (P1C2, P2C2, P3C2, P4C2, P5C2, P6C2, P7C2, PC2, C2),
        (P1C3, P2C3, P3C3, P4C3, P5C3, P6C3, P7C3, PC3, C3),
        (P1C4, P2C4, P3C4, P4C4, P5C4, P6C4, P7C4, PC4, C4),
        (PCA1, PCA2, PCA3, PCA4),
    )
    return result
